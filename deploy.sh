...
ssh ${SERVER} -p ${PORT} <<EOT
    ...
    if [ -f ${SERVER_ROOT_WHERE_DEPLOY_FOLDER}/${SERVER_FOLDER_NAME}/.htaccess ]; then
        cp ${SERVER_ROOT_WHERE_DEPLOY_FOLDER}/${SERVER_FOLDER_NAME}/.htaccess ${ZIP_TEMP_FOLDER_NAME}/;
    fi
    if [ -f ${SERVER_ROOT_WHERE_DEPLOY_FOLDER}/${SERVER_FOLDER_NAME}/web/robots.txt ]; then
        cp ${SERVER_ROOT_WHERE_DEPLOY_FOLDER}/${SERVER_FOLDER_NAME}/web/robots.txt ${ZIP_TEMP_FOLDER_NAME}/web/;
    fi
    ...
    if [ -d ${ZIP_TEMP_FOLDER_NAME}/${WP_THEME_PATH}/resources/assets/acf-json ]; then
        mkdir -p ${ZIP_TEMP_FOLDER_NAME}/${WP_THEME_PATH}/tmp/acf-json;
        cp -r ${ZIP_TEMP_FOLDER_NAME}/${WP_THEME_PATH}/resources/assets/acf-json/* ${ZIP_TEMP_FOLDER_NAME}/${WP_THEME_PATH}/tmp/acf-json/;
        rm -rf ${ZIP_TEMP_FOLDER_NAME}/${WP_THEME_PATH}/resources/assets;
        mkdir -p ${ZIP_TEMP_FOLDER_NAME}/${WP_THEME_PATH}/resources/assets/acf-json;
        cp -r ${ZIP_TEMP_FOLDER_NAME}/${WP_THEME_PATH}/tmp/acf-json/* ${ZIP_TEMP_FOLDER_NAME}/${WP_THEME_PATH}/resources/assets/acf-json/;
        rm -rf ${ZIP_TEMP_FOLDER_NAME}/${WP_THEME_PATH}/tmp/acf-json;
    fi
    ...
    cd ${SERVER_ROOT_WHERE_DEPLOY_FOLDER}/${SERVER_FOLDER_NAME}/web/app;
    chmod -R 777 ./uploads;
    cd ${SERVER_ROOT_WHERE_DEPLOY_FOLDER}/${SERVER_FOLDER_NAME}/${WP_THEME_PATH}/resources/assets;
    chmod -R 777 ./acf-json;
EOT